...
$doc->addStyleSheet('//fonts.googleapis.com/css?family=Fredericka+the+Great');
$doc->addStyleSheet('//fonts.googleapis.com/css?family=Gabriela');
$doc->addStyleSheet('//fonts.googleapis.com/css?family=Henny+Penny');
